...
class UserAdmin(BaseUserAdmin):
    list_display = ("full_name", "email", "phone_number", "btc_balance", "referral_code", "referral_count", "date_joined", "is_staff")
    ...
    fieldsets = (
        (None, {"fields": ("id", "first_name", "last_name", "email", "phone_number", "password")}),
    ...
    add_fieldsets = (
        (None, {
            "classes": ("wide",),
            "fields": ("first_name", "last_name", "email", "phone_number", "password1", "password2", "agreed_to_terms"),
        }),
    )
